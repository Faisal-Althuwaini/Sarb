...
// same signing scheme, mirrored here rather than shared as a library
// module (same independently-deployable-services tradeoff as the DTOs
// mirrored across the Kafka-connected services).
@Component
